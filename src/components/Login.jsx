    ...
    <Stack spacing="8">
      ...
      <Stack spacing="6">
        <Stack spacing="4">
          ...
          <Button variant="solid" disabled>Continue with email</Button>
        </Stack>
        <HStack>
          <Divider />
          <Text fontSize="sm" color="muted" textTransform="uppercase">
            or
          </Text>
          <Divider />
        </HStack>
        <Stack spacing="3">
          <Button variant="outline" leftIcon={<GoogleIcon boxSize="5" />} iconSpacing="3" disabled>
            Continue with Google
          </Button>
          <Button variant="outline" leftIcon={<TwitterIcon boxSize="5" />} iconSpacing="3" disabled>
